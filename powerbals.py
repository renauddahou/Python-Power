...
print(f"\n[purple]Welcome to powerbals.py Sequence :[/purple] [blue](edit line 54&55 to change range)[/blue] ")
sleep(5)
threads_count = 1
threads = list()
...
def BTC_generate():
    Starting=1
    Stopping=115792089237316195423570985008687907852837564279074904382605163141518161494336
